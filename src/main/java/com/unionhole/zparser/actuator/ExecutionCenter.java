...
import com.unionhole.zparser.function.date.DateFunctions;
import com.unionhole.zparser.function.logic.LogicFunctions;
import com.unionhole.zparser.function.math.MathFunctions;
import com.unionhole.zparser.function.string.StringFunctions;
import com.unionhole.zparser.parser.*;
...
public class ExecutionCenter {
    ...
    private ExecutionCenter() {
        this(ExecutionConstants.SINGLE_QUOTE, true, true, true, true, true, true);
    }
    ...
    private ExecutionCenter(final char quoteCharacter,
                            ...
                            final boolean loadDateFunctions,
    ...
    public void putFunction(final BaseFunction baseFunction) {
        ...
        if (existingBaseFunction == null) {
            ...
            throw new IllegalArgumentException("具有相同名称的函数已存在" + existingBaseFunction.getName());
        }
    }
    ...
    private void loadSystemFunctions() {
        ...
        if (loadDateFunctions) {
            final FunctionGroup dateFunctions = (FunctionGroup) new DateFunctions();
    ...
    public boolean getDateLogicFunctions() {
        return loadDateFunctions;
    }
