...
/**
 * @author James.Zou
 * @Description:获取当前时间是周几
 *
 * @date 6/16/23 3:42 PM
 */
public class CURRENTWEEKFunction extends BaseFunction {
    @Override
    public String getName() {
        return DateFunctionTypeEnum.CURRENTWEEK_FUNCTION.getType();
    }
