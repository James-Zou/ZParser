...
/**
 * @author James.Zou
 * @Description:获取指定天时分秒 根据指定天时间戳
 *
 * @date 6/16/23 3:42 PM
 */
public class DAYMILLISMFunction extends BaseFunction {
    @Override
    public String getName() {
        return DateFunctionTypeEnum.DAYMILLISM_FUNCTION.getType();
    }
    ...
    public FunctionResult execute(ExecutionCenter executionCenter, String arguments) throws FunctionException {
        ...
        try {
            ...
            result = DateUtil.getDayMillisByDate(date,day);
        } catch (Exception e) {
