...
/**
 * @author James.Zou
 * @Description:获取指定天时分秒 根据指定天
 *
 * @date 6/16/23 3:42 PM
 */
public class DAYMILLISFunction extends BaseFunction {
    @Override
    public String getName() {
        return DateFunctionTypeEnum.DAYMILLIS_FUNCTION.getType();
    }
    ...
    public FunctionResult execute(ExecutionCenter executionCenter, String arguments) throws FunctionException {
        ...
        try {
           ...
           int day= (int) Math.floor(Double.valueOf(argumentTwo));
            ...
            result = DateUtil.getDayMillisByDate(argumentOne,day);
        } catch (Exception e) {
