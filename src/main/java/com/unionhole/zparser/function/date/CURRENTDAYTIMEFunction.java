...
/**
 * @author James.Zou
 * @Description:获取当天函数 时分秒
 *
 * @date 6/16/23 3:42 PM
 */
public class CURRENTDAYTIMEFunction extends BaseFunction {
    @Override
    public String getName() {
        return DateFunctionTypeEnum.CURRENTDAYTIME_FUNCTION.getType();
    }
    ...
    public FunctionResult execute(ExecutionCenter executionCenter, String arguments) throws FunctionException {
        ...
        try {
            result = DateUtil.getCurrentDayMillis();
        } catch (Exception e) {
