...
/**
 * @author James.Zou
 * @Description:获取指定天的时间戳
 *
 * @date 6/16/23 3:42 PM
 */
public class TIMEMILLISFunction extends BaseFunction {
    @Override
    public String getName() {
        return DateFunctionTypeEnum.TIMEMILLIS_FUNCTION.getType();
    }
    ...
    public FunctionResult execute(ExecutionCenter executionCenter, String arguments) throws FunctionException {
        ...
        try {
            ...
            result = String.valueOf(DateUtil.getTimeMillis((int) Math.floor(day)));
        } catch (Exception e) {
