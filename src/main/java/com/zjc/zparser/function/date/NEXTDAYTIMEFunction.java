...
/**
 * @author James.Zou
 * @Description:获取下一天函数 时分秒
 *
 * @date 6/16/23 3:42 PM
 */
public class NEXTDAYTIMEFunction extends BaseFunction {
    @Override
    public String getName() {
        return DateFunctionTypeEnum.NEXTDAYTIME_FUNCTION.getType();
    }
    ...
    public FunctionResult execute(ExecutionCenter executionCenter, String arguments) throws FunctionException {
        ...
        try {
            result = DateUtil.getNextDayMillis();
        } catch (Exception e) {
