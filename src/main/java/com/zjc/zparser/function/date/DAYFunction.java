...
/**
 * @author James.Zou
 * @Description:获取指定天 根据指定天
 *
 * @date 6/16/23 3:42 PM
 */
public class DAYFunction extends BaseFunction {
    @Override
    public String getName() {
        return DateFunctionTypeEnum.DAY_FUNCTION.getType();
    }
    ...
    public FunctionResult execute(ExecutionCenter executionCenter, String arguments) throws FunctionException {
        ...
        try {
           ...
           int day= (int) Math.floor(Double.valueOf(argumentTwo));
            ...
            result = DateUtil.getDayByDate(argumentOne,day);
        } catch (Exception e) {
